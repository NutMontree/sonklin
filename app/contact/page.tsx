            ...
            <div className="min-h-[calc(100vh-80px)] flex flex-col md:flex-row bg-gray-50/50">
                ...
                <div className="relative md:w-5/12 bg-gray-900 text-white p-10 lg:p-16 flex flex-col justify-center items-start overflow-hidden">
                    ...
                    <div className="relative z-10 w-full max-w-md mx-auto md:mx-0">
                        ...
                        <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight">ติดต่อเรา</h1>
                        <p className="text-gray-300 text-sm md:text-base leading-relaxed mb-10">
                            เรายินดีรับฟังทุกความคิดเห็นและข้อเสนอแนะของคุณ เพื่อนำไปพัฒนาการบริการให้ดียิ่งขึ้น กรุณากรอกแบบฟอร์มด้านข้าง แล้วทีมงานของเราจะรีบติดต่อกลับโดยเร็วที่สุด
                        </p>
                        ...
                        <div className="space-y-6 mb-12">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">ที่อยู่</p>
                                    <p className="text-sm font-medium text-gray-100 mt-1">ร้านซ่อนกลิ่น Kantharalak, Thailand, Sisaket</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center border border-white/5">
                                ...
                                <div>
                                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">เบอร์โทรศัพท์</p>
                                    <p className="text-sm font-medium text-gray-100 mt-1">080-323-5682</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center border border-white/5">
                                ...
                                <div>
                                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">อีเมล</p>
                                    <p className="text-sm font-medium text-gray-100 mt-1">nutmontree29@gmail.com</p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="md:w-7/12 p-6 md:p-10 lg:p-16 flex justify-center items-center relative">
                    ...
                    >
                        <div>
                            ...
                            <p className="text-sm font-medium text-gray-500 mt-2">กรุณากรอกข้อมูลให้ครบถ้วนเพื่อให้เราติดต่อกลับได้สะดวกยิ่งขึ้น</p>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex flex-col gap-2">
                                <label className="text-xs font-black uppercase tracking-widest text-gray-400">ชื่อของคุณ</label>
                                <input
                                    type="text"
                                    name="name"
                            ...
                            <div className="flex flex-col gap-2">
                                <label className="text-xs font-black uppercase tracking-widest text-gray-400">อีเมล</label>
                                <input
                                    type="email"
                                    name="email"
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-xs font-black uppercase tracking-widest text-gray-400">หัวข้อเรื่อง</label>
                            <input
                                type="text"
                                name="subject"
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-xs font-black uppercase tracking-widest text-gray-400">ข้อความ</label>
                            <textarea
                                name="message"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className={`w-full py-4 mt-2 rounded-xl text-white font-black uppercase tracking-widest text-sm shadow-xl transition-all active:scale-[0.98] ${loading
